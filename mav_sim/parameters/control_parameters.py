...
pitch_kp: float = (wn_pitch**2 - TF.a_theta2) / TF.a_theta3 # Implement
pitch_kd: float = (2 * zeta_pitch * wn_pitch - TF.a_theta1) / TF.a_theta3 # Implement
wn_theta_squared = TF.a_theta2 + pitch_kp * TF.a_theta3 # Implement
K_theta_DC: float = pitch_kp * TF.a_theta3 / wn_theta_squared # Implement
